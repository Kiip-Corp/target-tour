  ...
  return (
    <div style={{ padding: 24, fontFamily: "ui-monospace, monospace", fontSize: 13 }}>
      ...
      <p style={{ fontSize: 12, color: "#6B7280", marginBottom: 14, lineHeight: 1.7 }}>
        ...
        기준입니다. 의료 자료만 파고드는 화면은 위 탭의 <b>② 의료관광</b> 보드입니다.
      </p>
      ...
      <DataSources
        ...
        items={[
          ...
          {
            key: "medicalRegion",
            use: "패널 1의 “의료소비·지역” 선 (지도·랭킹은 ② 의료관광 보드에 있습니다)",
          },
        ]}
      />
      ...
      >
        ...
        <br />
        <b>② 의료는 국가와 지역이 교차되지 않습니다.</b> 「국가별 의료소비」는{" "}
        <b>지역 구분이 없는</b> 전국 합계, 「지역별 의료소비」는 <b>국가 구분이 없는</b> 전체 외국인
        ...
        다만 두 자료는 지표·단위가 같아서 — 「국가별 의료소비」의 비율로 역산한 전체 외국인 소비액이
        「지역별 의료소비」의 <b>&ldquo;전국&rdquo;</b> 값과 일치합니다 — 같은 파이의 두 단면으로
        읽어도 됩니다. 국가 × 지역까지 곱하려면 &ldquo;국가별 × 지역별 × 월별&rdquo; 원자료가 따로
        필요합니다.
        <br />
